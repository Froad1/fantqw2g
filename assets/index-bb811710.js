 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vq(n){cU(yi),hi(new Rn("database",(e,{instanceIdentifier:t})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return pq(i,s,r,t)},"PUBLIC").setMultipleInstances(!0)),gn(ow,aw,n),gn(ow,aw,"esm2017")}li.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};li.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};vq();const wq=(n,e)=>{const t=n.__vccOpts||n;for(const[i,s]of e)t[i]=s;return t},Iq={data(){return{isPlaying:!1,user:null,username:null,authorized:!1,loginPage:!0,regUsername:null,regPassword:null,regEmail:null,regGooglePage:!1,url:"",player:null,RoomUid:null,inRoom:!1,allrooms:[],passwordRoomType:!1,passwordRoom:"",connPasswordRoomType:!1,connPasswordRoom:"",showAllRoomList:!1,showProfile:!1,showOverlay:!1,errorInput:!1}},mounted(){const n={apiKey:"AIzaSyCxVh1JsLTRMXSLipjB3QSwRqd2o7N6FaA",authDomain:"fantqw2g.firebaseapp.com",databaseURL:"https://fantqw2g-default-rtdb.europe-west1.firebasedatabase.app",projectId:"fantqw2g",storageBucket:"fantqw2g.appspot.com",messagingSenderId:"1093154126781",appId:"1:1093154126781:web:c5624592aa67d6a83df0d4",measurementId:"G-VBDDXQSXD4"};Re.initializeApp(n),Re.firestore(),Re.auth().onAuthStateChanged(e=>{if(e){this.user=e,this.authorized=!0;const t=Gd(),i=Tl(t,"users/"+e.uid);uq(i,s=>{const r=s.val();this.username=r.username})}}),this.alredyInRoom()},methods:{togglePlayback(){const e=Re.firestore().collection("rooms").doc(this.RoomUid);document.getElementById("player").addEventListener("play",()=>{this.isPlaying=!0,console.log(this.isPlaying);let t=this.isPlaying;e.update({isPlaying:t})}),document.getElementById("player").addEventListener("pause",()=>{this.isPlaying=!1,console.log(this.isPlaying);let t=this.isPlaying;e.update({isPlaying:t})})},initializePlayer(n){this.player=new Playerjs({id:"player",file:n})},signInEmail(){Re.auth().signInWithEmailAndPassword(this.regEmail,this.regPassword).then(()=>{}).catch(n=>{var e=n.code,t=n.message;console.error("Помилка входу",e,t)})},signInGoogle(){const n=new Re.auth.GoogleAuthProvider;Re.auth().signInWithPopup(n).then(e=>{this.user=e.user,this.authorized=!0}).catch(e=>{const t=e.code,i=e.message;console.log(t,i)})},signOut(){Re.auth().signOut().then(()=>{this.user=null,this.authorized=!1}).catch(n=>{console.log(n)}),this.closeOutOverlay()},signUpEmail(){Re.auth().createUserWithEmailAndPassword(this.regEmail,this.regPassword).then(n=>{this.user=n;const e=Gd();Bw(Tl(e,"users/"+n.user.uid),{username:this.regUsername,email:this.regEmail});const t=this.regUsername;cq(Tl(e,"usernames/"),{[t]:n.user.uid})}).catch(function(n){var e=n.code,t=n.message;console.error("Помилка реєстрації",e,t)})},signUpGoogle(){const n=new Re.auth.GoogleAuthProvider;Re.auth().signInWithPopup(n).then(e=>{this.user=e.user,this.authorized=!0;const t=Gd();Bw(Tl(t,"users/"+e.user.uid),{username:this.regUsername,email:e.user.email})}).catch(e=>{const t=e.code,i=e.message;console.log(t,i)})},createRoom(){this.initializePlayer(this.url);const n=Re.firestore(),e=this.user.uid,t={withPassw:this.passwordRoomType,password:this.passwordRoomType?this.passwordRoom:"",isPlaying:this.isPlaying,users:[e],videoUrl:this.url};n.collection("rooms").add(t).then(i=>{this.RoomUid=i.id,console.log("Document written with ID: ",i.id),console.log(this.RoomUid),this.inRoom=!0,this.roomChanges(),this.togglePlayback()}).catch(i=>{console.error("Error adding document: ",i)})},connectToRoom(){const e=Re.firestore().collection("rooms").doc(this.RoomUid);e.get().then(t=>{console.log(this.inRoom),this.inRoom?(this.initializePlayer(t.data().videoUrl),this.inRoom=!0,this.roomChanges(),this.togglePlayback()):t.data().withPassw?(this.connPasswordRoomType=!0,this.connPasswordRoom==t.data().password?(this.errorInput=!1,this.initializePlayer(t.data().videoUrl),this.inRoom=!0,this.roomChanges(),this.togglePlayback()):this.errorInput=!0):(this.initializePlayer(t.data().videoUrl),this.inRoom=!0,this.roomChanges(),this.togglePlayback())}),e.update({users:Re.firestore.FieldValue.arrayUnion(this.user.uid)})},exitRoom(){Re.firestore().collection("rooms").doc(this.RoomUid).update({users:Re.firestore.FieldValue.arrayRemove(this.user.uid)}),document.getElementById("player").innerHTML="",document.getElementById("player").style="",this.player=null,this.RoomUid=null,this.inRoom=!1},deleteRoom(){Re.firestore().collection("rooms").doc(this.RoomUid).delete().then(()=>{document.getElementById("player").innerHTML="",document.getElementById("player").style="",this.player=null,this.RoomUid=null,this.inRoom=!1})},roomChanges(){Re.firestore().collection("rooms").doc(this.RoomUid).onSnapshot(t=>{const i=t.data();i.isPlaying?this.player.api("play"):this.player.api("pause"),this.isPlaying=i.isPlaying,console.log("Changes",this.isPlaying)})},changeRoomUrl(){Re.firestore().collection("rooms").doc(this.RoomUid).update({videoUrl:this.url}),this.player=null,this.initializePlayer(this.url)},alredyInRoom(){if(this.authorized){const n=Re.firestore();n.collection("rooms").get().then(e=>{e.empty||e.forEach(t=>{n.collection("rooms").doc(t.id).get().then(s=>{s.data().users.includes(this.user.uid)&&(this.inRoom=!0,this.RoomUid=t.id,this.connectToRoom())})})})}},showAllRoomsList(){Re.firestore().collection("rooms").get().then(t=>{const i=[];t.forEach(s=>{var r=s.data();i.push({id:s.id,withpassw:r.withPassw,users:r.users.length})}),this.allrooms=i}).catch(t=>{console.log("Помилка отримання документів:",t)}),this.showProfile&&(this.showProfile=!this.showProfile),this.showAllRoomList=!this.showAllRoomList,this.showOverlay=!this.showOverlay},showProfileInfo(){this.showAllRoomList&&(this.showAllRoomList=!this.showAllRoomList),this.showProfile=!this.showProfile,this.showOverlay=!this.showOverlay},closeOutOverlay(){this.showProfile=!1,this.showAllRoomList=!1,this.showOverlay=!1}}},at=n=>(PA("data-v-c069934a"),n=n(),DA(),n),Eq={class:"header"},Tq=at(()=>j("div",{class:"logo"},[j("a",{href:"",class:"logo__1"},"fantq"),j("span",{class:"logo__2"},"w2g")],-1)),bq={class:"right"},Cq={class:"theme__change"},Sq=at(()=>j("svg",{xmlns:"http://www.w3.org/2000/svg",height:"24",viewBox:"0 96 960 960",width:"24",class:"icon dark_mode"},[j("path",{d:"M480 936q-150 0-255-105T120 576q0-150 105-255t255-105q14 0 27.5 1t26.5 3q-41 29-65.5 75.5T444 396q0 90 63 153t153 63q55 0 101-24.5t75-65.5q2 13 3 26.5t1 27.5q0 150-105 255T480 936Zm0-80q88 0 158-48.5T740 681q-20 5-40 8t-40 3q-123 0-209.5-86.5T364 396q0-20 3-40t8-40q-78 32-126.5 102T200 576q0 116 82 198t198 82Zm-10-270Z"})],-1)),Aq={xmlns:"http://www.w3.org/2000/svg",height:"24",viewBox:"0 96 960 960",width:"24",class:"icon light_mode",style:{display:"none"}},kq=at(()=>j("path",{d:"M480 696q50 0 85-35t35-85q0-50-35-85t-85-35q-50 0-85 35t-35 85q0 50 35 85t85 35Zm0 80q-83 0-141.5-58.5T280 576q0-83 58.5-141.5T480 376q83 0 141.5 58.5T680 576q0 83-58.5 141.5T480 776ZM80 616q-17 0-28.5-11.5T40 576q0-17 11.5-28.5T80 536h80q17 0 28.5 11.5T200 576q0 17-11.5 28.5T160 616H80Zm720 0q-17 0-28.5-11.5T760 576q0-17 11.5-28.5T800 536h80q17 0 28.5 11.5T920 576q0 17-11.5 28.5T880 616h-80ZM480 296q-17 0-28.5-11.5T440 256v-80q0-17 11.5-28.5T480 136q17 0 28.5 11.5T520 176v80q0 17-11.5 28.5T480 296Zm0 720q-17 0-28.5-11.5T440 976v-80q0-17 11.5-28.5T480 856q17 0 28.5 11.5T520 896v80q0 17-11.5 28.5T480 1016ZM226 378l-43-42q-12-11-11.5-28t11.5-29q12-12 29-12t28 12l42 43q11 12 11 28t-11 28q-11 12-27.5 11.5T226 378Zm494 495-42-43q-11-12-11-28.5t11-27.5q11-12 27.5-11.5T734 774l43 42q12 11 11.5 28T777 873q-12 12-29 12t-28-12Zm-42-495q-12-11-11.5-27.5T678 322l42-43q11-12 28-11.5t29 11.5q12 12 12 29t-12 28l-43 42q-12 11-28 11t-28-11ZM183 873q-12-12-12-29t12-28l43-42q12-11 28.5-11t27.5 11q12 11 11.5 27.5T282 830l-42 43q-11 12-28 11.5T183 873Zm297-297Z"},null,-1)),Rq=[kq],Nq=["src"],xq={key:0,class:"profile_info"},Pq={class:"profile_info_container"},Dq={key:0,style:{"font-size":"1.2rem"}},Oq=at(()=>j("div",null,"Ваш UID:",-1)),Mq={key:1,style:{"font-size":"0.8rem"}},Lq={key:0,class:"all_rooms"},Fq=at(()=>j("path",{d:"M120-240v-60h720v60H120Zm0-210v-60h720v60H120Zm0-210v-60h720v60H120Z"},null,-1)),Uq=[Fq],Vq={key:0,class:"all_room_list"},Bq=at(()=>j("p",null,"Всі кімнати:",-1)),qq={class:"all_rooms_id"},$q={key:0,class:"icon roomlock",xmlns:"http://www.w3.org/2000/svg",height:"48",viewBox:"0 -960 960 960",width:"48"},jq=at(()=>j("path",{d:"M220-80q-24.75 0-42.375-17.625T160-140v-434q0-24.75 17.625-42.375T220-634h70v-96q0-78.85 55.606-134.425Q401.212-920 480.106-920T614.5-864.425Q670-808.85 670-730v96h70q24.75 0 42.375 17.625T800-574v434q0 24.75-17.625 42.375T740-80H220Zm0-60h520v-434H220v434Zm260.168-140Q512-280 534.5-302.031T557-355q0-30-22.668-54.5t-54.5-24.5Q448-434 425.5-409.5t-22.5 55q0 30.5 22.668 52.5t54.5 22ZM350-634h260v-96q0-54.167-37.882-92.083-37.883-37.917-92-37.917Q426-860 388-822.083 350-784.167 350-730v96ZM220-140v-434 434Z"},null,-1)),zq=[jq],Wq={key:1,class:"login_container"},Gq={class:"login"},Kq=at(()=>j("button",null,"Ввійти",-1)),Hq={key:2,class:"registration_container"},Qq={class:"registration"},Yq=at(()=>j("button",null,"Зареєструватися",-1)),Xq=at(()=>j("button",null,"Зареєструватися",-1)),Jq={key:3,class:"player_container"},Zq=at(()=>j("div",{id:"player"},null,-1)),e4=[Zq],t4={key:4,class:"main_page"},n4={class:"main_page_container"},i4=at(()=>j("button",{class:"createRoom"},"Cтворити кімнату",-1)),s4={class:"password"},r4=at(()=>j("label",{for:"with_passw"},"З паролем",-1)),o4=at(()=>j("label",{for:"without_passw"},"Без пароля",-1)),a4=at(()=>j("button",{class:"createRoom"},"Підʼєднатися до кімнати",-1)),c4={key:5,class:"room_info"},l4=at(()=>j("div",null,"ID кімнати: ",-1)),u4={key:6,class:"room_buttons"},h4=at(()=>j("button",{class:"createRoom"},"Вийти з кімнати",-1)),d4=[h4],f4=at(()=>j("button",{class:"createRoom"},"Змінити відео",-1)),p4=at(()=>j("button",{class:"createRoom"},"Видалити кімнату",-1)),g4=[p4];function m4(n,e,t,i,s,r){return _e(),Te(sn,null,[s.showOverlay?(_e(),Te("div",{key:0,class:"overlay",onClick:e[0]||(e[0]=(...o)=>r.closeOutOverlay&&r.closeOutOverlay(...o))})):He("",!0),j("header",Eq,[Tq,j("div",bq,[j("div",Cq,[Sq,(_e(),Te("svg",Aq,Rq))]),s.user?(_e(),Te("img",{key:0,src:s.user.photoURL,class:"avatar",onClick:e[1]||(e[1]=(...o)=>r.showProfileInfo&&r.showProfileInfo(...o))},null,8,Nq)):He("",!0)]),Vt(Kl,{name:"profile"},{default:tf(()=>[s.showProfile?(_e(),Te("div",xq,[j("div",Pq,[s.username?(_e(),Te("div",Dq,tl(s.username),1)):He("",!0),Oq,s.user?(_e(),Te("p",Mq,tl(s.user.uid),1)):He("",!0),s.authorized?(_e(),Te("button",{key:2,class:"signOut",onClick:e[2]||(e[2]=(...o)=>r.signOut&&r.signOut(...o))},"SignOut")):He("",!0)])])):He("",!0)]),_:1})]),j("main",null,[s.authorized?(_e(),Te("div",Lq,[(_e(),Te("svg",{onClick:e[3]||(e[3]=(...o)=>r.showAllRoomsList&&r.showAllRoomsList(...o)),xmlns:"http://www.w3.org/2000/svg",height:"48",viewBox:"0 -960 960 960",width:"48",class:"icon all_rooms_button"},Uq)),Vt(Kl,{name:"allRoom"},{default:tf(()=>[s.showAllRoomList?(_e(),Te("div",Vq,[Bq,j("div",null,[(_e(!0),Te(sn,null,Fy(s.allrooms,o=>(_e(),Te("div",{key:o.id,class:"room-id"},[j("div",qq,tl(o.id),1),j("span",null,[o.withpassw?(_e(),Te("svg",$q,zq)):He("",!0)]),(_e(!0),Te(sn,null,Fy(o.users,a=>(_e(),Te("div",{class:"users_circle_count",key:a}))),128))]))),128))])])):He("",!0)]),_:1})])):He("",!0),!s.authorized&&s.loginPage?(_e(),Te("div",Wq,[j("div",Gq,[j("form",{onSubmit:e[6]||(e[6]=Ai((...o)=>r.signInEmail&&r.signInEmail(...o),["prevent"])),class:"signIn_form"},[nn(j("input",{type:"text",placeholder:"E-mail","onUpdate:modelValue":e[4]||(e[4]=o=>s.regEmail=o),required:""},null,512),[[vn,s.regEmail]]),nn(j("input",{type:"text",placeholder:"Пароль","onUpdate:modelValue":e[5]||(e[5]=o=>s.regPassword=o),required:""},null,512),[[vn,s.regPassword]]),Kq],32),j("button",{class:"signIn",onClick:e[7]||(e[7]=(...o)=>r.signInGoogle&&r.signInGoogle(...o))},"Увійти через Google"),j("button",{class:"signUpEmail",onClick:e[8]||(e[8]=()=>{this.loginPage=!this.loginPage})},"Зареєструватися")])])):He("",!0),!s.authorized&&!s.loginPage?(_e(),Te("div",Hq,[j("div",Qq,[s.regGooglePage?He("",!0):(_e(),Te("form",{key:0,onSubmit:e[12]||(e[12]=Ai((...o)=>r.signUpEmail&&r.signUpEmail(...o),["prevent"])),class:"registration_form"},[nn(j("input",{type:"text",placeholder:"Нікнейм","onUpdate:modelValue":e[9]||(e[9]=o=>s.regUsername=o),required:""},null,512),[[vn,s.regUsername]]),nn(j("input",{type:"text",placeholder:"E-mail","onUpdate:modelValue":e[10]||(e[10]=o=>s.regEmail=o),required:""},null,512),[[vn,s.regEmail]]),nn(j("input",{type:"text",placeholder:"Пароль","onUpdate:modelValue":e[11]||(e[11]=o=>s.regPassword=o),required:""},null,512),[[vn,s.regPassword]]),Yq],32)),s.regGooglePage?(_e(),Te("form",{key:1,onSubmit:e[14]||(e[14]=Ai((...o)=>r.signUpGoogle&&r.signUpGoogle(...o),["prevent"]))},[nn(j("input",{type:"text",placeholder:"Нікнейм","onUpdate:modelValue":e[13]||(e[13]=o=>s.regUsername=o),required:""},null,512),[[vn,s.regUsername]]),Xq],32)):He("",!0),s.regGooglePage?(_e(),Te("button",{key:2,class:"signUpGoogle",onClick:e[15]||(e[15]=()=>{this.regGooglePage=!this.regGooglePage})},"Зареєструватися через E-mail")):He("",!0),s.regGooglePage?He("",!0):(_e(),Te("button",{key:3,class:"signUpGoogle",onClick:e[16]||(e[16]=()=>{this.regGooglePage=!this.regGooglePage})},"Зареєструватися через Google")),j("button",{class:"signUpEmail",onClick:e[17]||(e[17]=()=>{this.loginPage=!this.loginPage})},"Увійти")])])):He("",!0),s.authorized?(_e(),Te("div",Jq,e4)):He("",!0),s.authorized&&!s.inRoom?(_e(),Te("div",t4,[j("div",n4,[j("form",{onSubmit:e[22]||(e[22]=Ai((...o)=>r.createRoom&&r.createRoom(...o),["prevent"])),class:"creat_room-form"},[i4,nn(j("input",{type:"text",placeholder:"Посилання на відео","onUpdate:modelValue":e[18]||(e[18]=o=>s.url=o),required:""},null,512),[[vn,s.url]]),j("div",s4,[r4,nn(j("input",{id:"with_passw",type:"radio",name:"passwordType","onUpdate:modelValue":e[19]||(e[19]=o=>s.passwordRoomType=o),value:!0,required:""},null,512),[[c_,s.passwordRoomType]]),o4,nn(j("input",{id:"without_passw",type:"radio",name:"passwordType","onUpdate:modelValue":e[20]||(e[20]=o=>s.passwordRoomType=o),value:!1,required:""},null,512),[[c_,s.passwordRoomType]])]),s.passwordRoomType?nn((_e(),Te("input",{key:0,type:"password",placeholder:"Пароль","onUpdate:modelValue":e[21]||(e[21]=o=>s.passwordRoom=o),required:""},null,512)),[[vn,s.passwordRoom]]):He("",!0)],32),j("form",{onSubmit:e[25]||(e[25]=Ai((...o)=>r.connectToRoom&&r.connectToRoom(...o),["prevent"])),class:"connect_room-form"},[a4,nn(j("input",{type:"text",placeholder:"ID кімнати","onUpdate:modelValue":e[23]||(e[23]=o=>s.RoomUid=o),required:""},null,512),[[vn,s.RoomUid]]),s.connPasswordRoomType?nn((_e(),Te("input",{key:0,type:"text",placeholder:"Пароль","onUpdate:modelValue":e[24]||(e[24]=o=>s.connPasswordRoom=o),style:Vu({border:s.errorInput?"1px solid rgba(255, 0, 0, 0.6)":" 1px solid transparent"}),required:""},null,4)),[[vn,s.connPasswordRoom]]):He("",!0)],32)])])):He("",!0),s.inRoom&&s.RoomUid?(_e(),Te("div",c4,[l4,j("div",null,tl(this.RoomUid),1)])):He("",!0),s.authorized&&s.inRoom?(_e(),Te("div",u4,[j("form",{onSubmit:e[26]||(e[26]=Ai((...o)=>r.exitRoom&&r.exitRoom(...o),["prevent"]))},d4,32),j("form",{onSubmit:e[28]||(e[28]=Ai((...o)=>r.changeRoomUrl&&r.changeRoomUrl(...o),["prevent"])),class:"change_room_url"},[nn(j("input",{class:"change_room_url_input",type:"text",placeholder:"Посилання на відео","onUpdate:modelValue":e[27]||(e[27]=o=>s.url=o),required:""},null,512),[[vn,s.url]]),f4],32),j("form",{onSubmit:e[29]||(e[29]=Ai((...o)=>r.deleteRoom&&r.deleteRoom(...o),["prevent"]))},g4,32)])):He("",!0)])],64)}const y4=wq(Iq,[["render",m4],["__scopeId","data-v-c069934a"]]);dR(y4).mount("#app");
